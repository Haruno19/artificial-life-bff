...
pub const EPOCHS: usize = 30_000; // total epochs to run (1 epoch = SOUP_SIZE/2 pairings)
...
// Sample logging
pub const SAMPLE_COUNT: usize = 10;     // tapes captured per snapshot
pub const SAMPLE_STEPS: usize = 2_500; // write a sample snapshot every N epochs

// Replicator cataloguing (expensive — runs less often than the basic stats)
pub const REPL_STEPS: usize = 5_000;
